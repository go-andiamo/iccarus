...
func TestInterpolate1D(t *testing.T) {
	assert.InDelta(t, 0.0, interpolate1D(0, 1, 0.0), 0.0001)
	assert.InDelta(t, 1.0, interpolate1D(0, 1, 1.0), 0.0001)
	assert.InDelta(t, 0.5, interpolate1D(0, 1, 0.5), 0.0001)
	assert.InDelta(t, 0.25, interpolate1D(0, 1, 0.25), 0.0001)
	assert.InDelta(t, 0.75, interpolate1D(0, 1, 0.75), 0.0001)

	assert.InDelta(t, 2.0, interpolate1D(2, 4, 0.0), 0.0001)
	assert.InDelta(t, 3.0, interpolate1D(2, 4, 0.5), 0.0001)
	assert.InDelta(t, 4.0, interpolate1D(2, 4, 1.0), 0.0001)
}
